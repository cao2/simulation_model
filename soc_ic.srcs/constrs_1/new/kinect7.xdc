...
#set_property PACKAGE_PIN K28 [get_ports Clock]
#set_property IOSTANDARD LVDS_25 [get_ports Clock]

#set_property PACKAGE_PIN K28 [get_ports USER_CLOCK_P]
#set_property IOSTANDARD LVDS_25 [get_ports USER_CLOCK_P]
##USER SMA CLOCK
#set_property PACKAGE_PIN K25 [get_ports Clock]
#set_property IOSTANDARD LVDS_25 [get_ports Clock]
...
#UG810 (v1.7) July 8, 2016 www.xilinx.com
...
set_property IOSTANDARD LVCMOS25 [get_ports rx_in]
set_property PACKAGE_PIN M19 [get_ports tx_out]
set_property IOSTANDARD LVCMOS25 [get_ports tx_out]
#Note: Regarding USB UART-The XDC constraints for pins K24 and M19 do not match those in the
#Vivado part0_pins.xml file. See Kintex-7 KC705 FGPA Evaluation Kit Master Answer Record (AR
#45934) for more information.
#Send Feedback
#KC705 Evaluation Board 108
#UG810 (v1.7) July 8, 2016 www.xilinx.com
#Appendix C: Master Constraints File Listing
##XADC
